...
router.get('/cacherAcheter/:_id', Admin.cacherAcheter);
router.get('/afficheAcheter/:_id', Admin.afficheAcheter);
...
router.get('/modifierAtl/:_id', Admin.getid);

router.get('/supprimer/:_id', Admin.supprimer);
